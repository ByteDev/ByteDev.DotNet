...
namespace ByteDev.DotNet.UnitTests.Project
{
    ...
    public class DotNetProjectTargetTests
    {
        ...
        [TestCase("net471", TargetType.Framework, "471", ".NET Framework 4.7.1")]
        ...
        public void WhenTargetIsValid_ThenSetProperties(string targetValue, TargetType type, string version, string description)
        {
